...
public class Delete_Timetable extends JFrame{
	...
	public  Delete_Timetable() {
		...
		setVisible(true);
		setSize(500,600);
		setTitle("Delete your timetable for that day:");
		...
		in.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					String sql="DELETE FROM timetable where class=? and section=? and starttime=? and endtime=?";
					PreparedStatement statement=con.prepareStatement(sql);
					statement.setString(1,bclass.getText());
					statement.setString(2,bsection.getText());
					statement.setString(3,bstarttime.getText());
					statement.setString(4,bendtime.getText());
